...
import { useDayzed, DayzedProps } from '../dayzed'
import { ArrowKeysReact } from '../utils/reactKeysArrow'
import React, { useCallback, useMemo } from 'react'
import { CalendarConfigs, DatepickerProps } from '../utils/types'
...
export interface CalendarPanelProps extends DatepickerProps {
  dayzedHookProps: Omit<DayzedProps, 'children' | 'render'>
  configs: CalendarConfigs
  disabledDates?: Set<number>
  onMouseEnterHighlight?: (date: Dayjs) => void
  isInRange?: (date: Dayjs) => boolean | null
}
